...
def write_page(path, title, desc, kw, gradient, subtitle, h2s):
...
# Overwatch - 1298c
PAGES.append(("overwatch/index.html",
...
# Dark Souls 3 - 1370c
PAGES.append(("dark-souls-3/index.html",
...
# Diablo 4 - 1372c
PAGES.append(("diablo-4/index.html",
...
# Roblox - 1373c
PAGES.append(("roblox/index.html",
...
# NBA 2K - 1377c
PAGES.append(("nba-2k/index.html",
...
# Rainbow Six Siege - 1388c
PAGES.append(("rainbow-six-siege/index.html",
...
# Dota 2 - 1393c
PAGES.append(("dota-2/index.html",
...
# Sekiro - 1397c
PAGES.append(("sekiro/index.html",
    ...
    [("Why Block Is Better Than Dodge (Most of the Time)",
     ...
     ("The Color System for Attack Types",
      "<strong style='color:#ef4444'>Red = unblockable.</strong> Use Mikiri Counter or dodge. <strong style='color:#f97316'>Orange = deflectable but late.</strong> Start deflect before the attack visually starts. <strong style='color:#fbbf24'>Yellow = sweep.</strong> Jump and stamp. <strong style='color:#60a5fa'>Blue = thrust.</strong> Mikiri Counter deals massive posture damage."),
...
# Valheim - 1407c
PAGES.append(("valheim/index.html",
    ...
    [("The 3 Builds That Dominate in 2026",
     ...
     ("Boss Progression: The Order That Saves Hours",
      "The game says \"find Bonemass\" but you shouldn't fight Bonemass first. <strong>The correct order: Eikthyr ( Meadows) - The Elder (Black Forest) - Bonemass (Swamp) - Yagluth (Mountain) - Moder (Plains) - Pyro (Ocean) - Queen (Ashlands).</strong> I fought Bonemass early on my first playthrough and died 20+ times. The equipment I needed was in the Black Forest mines, which I hadn't explored yet."),
...
# Last Epoch - 1414c
PAGES.append(("last-epoch/index.html",
    ...
    [("Why Forgeis Dominates in 1.0",
     ...
     ("The Timeline System Explained",
      "Timelines aren't just for loot - they're the progression system. Each timeline has a specific modifier (like \"enemies deal 30% more fire damage\"). The <strong>optimal approach:</strong> complete timelines on Normal first to unlock the timeline. Then on Hard for the rewards. Then ignore timeline level until you have 4-5 idols slot filled.")]))